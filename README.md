...
Th generic `summary` function provides an integrated view the sub-expressions with corresponding comments and names that make up the *concatenated expression*.
